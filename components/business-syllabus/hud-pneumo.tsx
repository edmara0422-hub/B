...
export function HudPneumo() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      ctx.strokeStyle = '#d2af5a' // var(--g-3)
      ctx.lineWidth = 1.75
          ...
          <div>
            ...
            <div className="c-slider-group mb-4">
              ...
              <select
                ...
                className="bg-[#0b0d12] border border-[#d2af5a]/15 text-white rounded-lg p-2 text-[10px] w-full outline-none mt-1 focus:border-[#d2af5a]/45"
              >
            ...
            <div className="border-t border-white/5 pt-3 mt-4 flex flex-col gap-1 font-mono text-[10px] text-white/45">
              ...
              <div className="flex justify-between"><span>Power Mecânico:</span><b className="text-[#d2af5a]">{mechanicalPower.toFixed(1)} J/min</b></div>
            </div>
          </div>
        </div>
      </div>
