...
export function StudyRailBoard({
  ...
  return (
    <div className="space-y-4">
      {/* Rail — bs-soft (paleta prata translúcida) */}
      <div className="bs-soft relative overflow-hidden rounded-[1.8rem] p-5 md:p-6">
        {/* Rail header */}
        ...
        {current ? (
          ...
          >
            {hideDetailHeader && current.panel ? (
              ...
              <div className="bs-soft relative overflow-hidden rounded-[1.8rem]">
                {/* Detail header */}
          ...
          <motion.div
            ...
            className="bs-soft flex items-center justify-center rounded-[1.8rem] py-12"
