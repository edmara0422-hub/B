  ...
  return (
    <div className="w-full">
      <style>{`
        ...
        .esg-q-tag.strat { background: rgba(201, 148, 58,0.12); color: #d2af5a; }
        ...
        {activeSubTab === 'diagnostico' ? (
          <div>
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="bg-[#d2af5a]/10 border border-[#d2af5a]/30 px-3.5 py-1.5 rounded-full text-[#d2af5a] font-mono text-[10px]">
            ...
            <div className="mt-6 text-right">
              <button
                className="bg-[#d2af5a]/15 hover:bg-[#d2af5a]/25 border border-[#d2af5a]/30 text-[#d2af5a] text-[10px] font-mono uppercase tracking-widest px-6 py-2.5 rounded-md transition"
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-white/[0.01] border border-white/[0.04] rounded-lg p-4 text-center space-y-2">
                ...
                <div className="h-1 bg-white/[0.08] rounded-full overflow-hidden">
                  <div
                    className="h-full bg-[#d2af5a] rounded-full transition-all duration-1000"
