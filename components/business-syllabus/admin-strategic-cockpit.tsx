          ...
          <div className="grid grid-cols-2 gap-4 w-full lg:w-auto">
             ...
             <div className="px-5 py-3 rounded-2xl bg-white/[0.03] border border-white/5 flex flex-col justify-between min-w-[160px] hover:border-white/10 transition-all">
                ...
                <div className="flex items-center gap-2">
                  <div className="h-8 w-8 rounded-lg bg-[#d2af5a]/10 border border-[#d2af5a]/20 flex items-center justify-center shrink-0">
                    <Target className="h-4.5 w-4.5 text-[#d2af5a]" />
                  </div>
                  <div>
            ...
            >
                    ...
                    {brief ? (
                      <div className="space-y-6">
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center gap-2">
                             <Zap className="h-3.5 w-3.5 text-[#d2af5a]" />
                             <span className="text-[10px] font-black text-[#d2af5a] uppercase tracking-widest">Ação Corretiva Imediata</span>
                          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="rounded-3xl border border-white/10 bg-slate-900/20 p-6 flex flex-col justify-center items-center text-center space-y-4 hover:border-white/20 transition-all shadow-lg">
                  <div className="h-12 w-12 rounded-2xl bg-[#d2af5a]/10 border border-white/10 flex items-center justify-center">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                 ...
                 <div className="rounded-[2rem] border border-white/10 bg-gradient-to-br from-slate-900/40 to-slate-950/60 p-6 md:p-8 flex flex-col items-center justify-between text-center space-y-6 shadow-xl">
                    <div className="space-y-4 w-full flex flex-col items-center">
                      <div className="h-14 w-14 rounded-2xl bg-[#d2af5a]/10 border border-[#d2af5a]/20 flex items-center justify-center">
                        <Users className="h-7 w-7 text-[#d2af5a]" />
                      </div>
                    ...
                    <div className="w-full space-y-2">
                      <div className="flex justify-between items-center text-[10px] uppercase font-bold text-white/40 tracking-wider">
                        ...
                        <span className="text-[#d2af5a] font-extrabold">85%</span>
                      </div>
                    ...
                    <span className="text-[9px] font-black text-[#d2af5a] uppercase tracking-widest bg-[#d2af5a]/10 border border-amber-400/20 px-3 py-1 rounded-full">Operação Sincronizada</span>
                 </div>
              </div>
            </motion.div>
          )}
...
function PositionSynthesisCard({ data, onReload }: { data: CockpitData; onReload: () => void }) {
  ...
  const statusBg = isRevenueGap && !isStructuralGap ? 'bg-red-500/10 border-red-500/20' : isStructuralGap ? 'bg-orange-500/10 border-orange-500/20' : windowOpen ? 'bg-[#d2af5a]/10 border-[#d2af5a]/20' : 'bg-slate-500/10 border-slate-500/20'
  ...
  return (
    <div className="rounded-3xl border border-white/10 bg-slate-900/30 p-6 space-y-5 shadow-xl hover:border-white/15 transition-all">
      ...
      <div className={`p-4 rounded-2xl border ${
        ...
        windowOpen ? 'bg-[#d2af5a]/5 border-[#d2af5a]/20' : 'bg-slate-500/5 border-slate-500/20'
      }`}>
            ...
            <div key={s.id} className="relative z-10 flex flex-col lg:flex-row items-center gap-4 w-full lg:w-auto">
               <div className="flex flex-col items-center gap-2">
                 <div className={`h-12 w-12 rounded-2xl border-2 flex items-center justify-center transition-all duration-500 shrink-0 ${
                   ...
                   isPast ? 'bg-[#d2af5a]/10 border-[#d2af5a]/30 text-white/90' : 
...
function LeadershipProcessCard({ state }: { state?: CockpitData['state']['leadership_process'] }) {
  ...
  return (
    <div className="rounded-[2.5rem] border border-white/10 bg-slate-900/30 p-6 md:p-8 shadow-xl">
      <div className="flex items-center gap-3 mb-8">
        <div className="h-12 w-12 rounded-2xl bg-[#d2af5a]/10 border border-[#d2af5a]/20 flex items-center justify-center">
          <Users2 className="h-6 w-6 text-[#d2af5a]" />
        </div>
        <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        {[
          ...
          <div key={item.id} className="relative p-5 rounded-2xl bg-white/[0.02] border border-white/5 flex flex-col justify-between items-center text-center space-y-4 hover:bg-white/[0.04] transition-all group">
             <div className="p-3 rounded-xl bg-white/5 group-hover:bg-[#d2af5a]/10 transition-all">
                <item.icon className={`h-6 w-6 transition-all duration-300 ${item.val > 50 ? 'text-[#d2af5a] scale-110' : 'text-white/20'}`} />
             </div>
             <div>
             ...
             <div className="w-full space-y-1.5">
                ...
                <span className="text-[10px] font-black text-[#d2af5a] block">{item.val}%</span>
             </div>
          </div>
        ))}
      </div>
  ...
  return (
    <div className="rounded-[2.5rem] border border-white/10 bg-gradient-to-br from-slate-900/40 via-slate-900/20 to-slate-950/60 p-6 md:p-8 shadow-xl">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 border-b border-white/5 pb-6">
        <div className="flex items-center gap-3">
          <div className="h-12 w-12 rounded-2xl bg-[#d2af5a]/10 border border-white/10 flex items-center justify-center shadow-lg shadow-emerald-500/10">
       ...
       <div className="space-y-2 max-h-[180px] overflow-y-auto pr-1 scrollbar-hide">
          {Object.entries(compliance.items).map(([label, active]) => (
            <div key={label} className="flex items-center justify-between p-3 rounded-xl bg-white/[0.02] border border-white/5 hover:border-white/10 transition-all">
               ...
               <div className={`h-5 w-5 rounded-lg border flex items-center justify-center shrink-0 ${active ? 'bg-[#d2af5a] border-emerald-400 text-slate-950 shadow-md shadow-emerald-500/10' : 'border-white/10 bg-white/5'}`}>
            ...
            return (
              <div key={label} className="relative z-10 flex flex-col items-center gap-3">
                 <div className={`h-11 w-11 rounded-2xl border-2 flex items-center justify-center transition-all duration-700 shrink-0 ${
                   ...
                   isDone ? 'bg-[#d2af5a]/10 border-[#d2af5a]/30 text-white/90' : 
                   'bg-white/5 border-white/10 text-white/20'
                 }`}>
            ...
            return (
              <div 
                ...
                className={`h-6 w-6 rounded-lg flex items-center justify-center text-[10px] font-black border transition-all ${
                  done ? 'bg-[#d2af5a]/20 border-emerald-500/40 text-white/90' : 
        ...
        {alerts.length === 0 ? (
          ...
          alerts.map(a => (
            <div key={a.id} className="p-4 bg-white/[0.01] border border-white/5 hover:border-violet-500/35 rounded-2xl flex items-start gap-4 group transition-all duration-300">
              <div className={`h-2.5 w-2.5 rounded-full mt-1.5 shrink-0 ${a.level === 'warning' ? 'bg-[#d2af5a] shadow-[0_0_8px_rgba(245,158,11,0.5)]' : 'bg-sky-400 shadow-[0_0_8px_rgba(56,189,248,0.5)]'}`} />
              <div className="flex-1 min-w-0">
  ...
  return (
    <div className="rounded-[2rem] border border-white/10 bg-slate-900/30 p-6 md:p-8 shadow-xl">
       <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-[#d2af5a]/10 border border-[#d2af5a]/20 flex items-center justify-center">
              <Goal className="h-5 w-5 text-[#d2af5a]" />
            </div>
            <div>
          ...
          {!okrs && (
            <button onClick={generate} disabled={loading} className="px-6 py-2.5 rounded-xl bg-[#d2af5a] text-slate-950 text-xs font-black uppercase tracking-widest hover:bg-amber-300 transition-all hover:scale-105 active:scale-95 disabled:opacity-30 shadow-lg shadow-amber-400/10 shrink-0">
       ...
       {okrs ? (
         <div className="space-y-5">
            <div className="p-4 rounded-xl bg-[#d2af5a]/5 border border-[#d2af5a]/10">
               <span className="text-[8px] font-black text-[#d2af5a] uppercase tracking-widest">Ciclo: {horizon}</span>
            ...
            {okrs.map((o: any, i: number) => (
               <div key={i} className="p-5 rounded-2xl bg-white/[0.01] border border-white/5 space-y-4 hover:border-white/10 transition-all">
                  <div className="flex items-center gap-3">
                     <span className="text-xs font-black text-[#d2af5a] bg-[#d2af5a]/5 border border-amber-400/10 px-2 py-0.5 rounded font-mono">OBJETIVO {i+1}</span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pl-4 border-l-2 border-white/10">
                     {(o.key_results ?? []).map((krObj: any, j: number) => (
                       <div key={j} className="flex gap-2.5">
                          <div className="h-1.5 w-1.5 rounded-full bg-[#d2af5a]/40 mt-1.5 shrink-0" />
