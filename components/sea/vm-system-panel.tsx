  ...
  return (
    <label className="space-y-1.5">
      ...
      <input
        ...
        className="h-8 w-full rounded-[0.6rem] ipb-soft px-2 text-[10px] text-white outline-none transition-all placeholder:text-white/24 focus:border-white/18"
      />
    </label>
  )
}
  ...
  return (
    <label className="space-y-1.5">
      ...
      <select
        value={value}
        onChange={(event) => onChange(event.target.value)}
        className="h-8 w-full rounded-[0.6rem] ipb-soft px-2 text-[10px] text-white outline-none transition-all focus:border-white/18"
      >
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="space-y-4">
        ...
        >
          <div className="space-y-3">
            <div className="rounded-[1.25rem] ipb-soft p-4">
      ...
      <div className="space-y-4">
        ...
        >
          <div className="grid gap-2 xl:grid-cols-3">
            {peepLevels.map((level, index) => (
              <div key={`level-${index}`} className="rounded-[1.15rem] ipb-soft p-3">
        ...
        >
          <div className="space-y-3">
            <div className="rounded-[1.15rem] ipb-soft p-3">
        ...
        >
          <div className="grid gap-2 grid-cols-2 md:grid-cols-3">
            {MRC_GROUPS.map((group) => (
              <div key={group.label} className="rounded-[1rem] ipb-soft p-2.5">
