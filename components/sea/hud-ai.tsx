    ...
    <div className="hud-card-container relative w-full h-full flex flex-col justify-between">
      ...
      <div className="hero-content relative z-20 grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-4" style={{ paddingBottom: '12px' }}>
        ...
        <div className="ai-chat-screen flex flex-col justify-between h-[420px] bg-[#000]/70 border border-white/5 rounded-2xl overflow-hidden relative">
          ...
          <div className="p-2 bg-black/60 border-b border-white/5 flex items-center justify-between gap-1.5 flex-wrap">
            <div className="flex items-center gap-1.5 text-[#d4b87a] font-mono text-[8px] uppercase tracking-wider font-bold">
            ...
            <div className="flex items-center gap-1.5">
              <select 
                ...
                className="bg-black/85 text-[8.5px] font-mono text-[#d4b87a] border border-[#d4b87a]/30 rounded px-1 py-0.5 outline-none focus:border-[#d4b87a]"
              >
              ...
              {(model.startsWith('deepseek') || model === 'grok-4.1-fast-reasoning') && (
                <select
                  ...
                  className="bg-black/90 text-[7.5px] font-mono text-amber-400 border border-amber-500/30 rounded px-1 py-0.5 outline-none"
                >
              ...
              {(model.startsWith('gemma') || model.startsWith('deepseek') || model === 'grok-4.1-fast-reasoning') && (
                <button 
                  ...
                  className={`px-1.5 py-0.5 rounded text-[7.5px] font-mono border transition-all flex items-center gap-0.5 cursor-pointer ${showThinking ? 'bg-amber-500/10 text-amber-400 border-amber-500/35' : 'text-white/20 border-white/10'}`}
                >
          ...
          <div className="ai-chat-messages flex-1 p-3 overflow-y-auto space-y-2 text-[10px] scrollbar-none">
            {chatHistory.map((m, idx) => (
              <div key={idx} className="space-y-1.5">
                ...
                {m.thought && (
                  <details className="group border border-amber-500/25 bg-amber-500/[0.04] rounded-lg p-2.5 font-mono text-[7.5px] text-amber-400/90 max-w-[85%] select-none cursor-pointer">
                    <summary className="font-bold flex items-center gap-1 uppercase tracking-wider text-amber-400/70">
                    ...
                    <div className="mt-1.5 border-t border-amber-500/10 pt-1.5 whitespace-pre-wrap leading-relaxed">
                      {m.thought}
                    </div>
                  </details>
                )}
                ...
                <div
                  className={`chat-msg p-2 px-3 rounded-xl max-w-[85%] leading-relaxed ${m.sender === 'user' ? 'bg-white/10 ml-auto text-white' : 'bg-[#d4b87a]/5 text-[#d4b87a] border border-[#d4b87a]/15'}`}
            ...
            {thinkingOutput && (
              <div className="border border-amber-500/30 bg-amber-500/[0.05] rounded-lg p-2.5 font-mono text-[7.5px] text-amber-400 max-w-[85%] animate-pulse space-y-1">
                <div className="font-bold uppercase tracking-wider text-[#d4b87a] flex items-center gap-1">
                  <span className="w-1.5 h-1.5 rounded-full bg-amber-400 animate-ping" />
                  <span>Modelo Pensando Passo a Passo...</span>
                </div>
                <div className="whitespace-pre-wrap leading-relaxed border-t border-amber-500/10 pt-1 mt-1 font-light">
                  {thinkingOutput}
                </div>
              </div>
            )}
          ...
          {model.startsWith('llama') && (
            <div className="absolute top-12 right-3 z-30 select-none animate-fadeIn">
              <span className="flex items-center gap-1 text-[7.5px] font-mono font-bold text-amber-400 bg-amber-500/10 border border-amber-500/30 px-2 py-0.5 rounded-full shadow-2xl">
          ...
          <div className="flex flex-wrap gap-1 px-3 pb-2 select-none">
            <span
              className="cursor-pointer px-2.5 py-1 text-[8.5px] font-mono font-semibold rounded-full bg-[#d4b87a]/10 border border-[#d4b87a]/25 text-[#d4b87a] hover:bg-[#d4b87a]/20 transition"
              onClick={() => triggerQuickAi('SWOT Viva Meta vs TikTok')}
            >
              SWOT Viva (Ads)
            </span>
            <span
              className="cursor-pointer px-2.5 py-1 text-[8.5px] font-mono font-semibold rounded-full bg-blue-500/10 border border-blue-500/25 text-blue-400 hover:bg-blue-500/20 transition"
              onClick={() => triggerQuickAi('Investir Caixa em CDI')}
            >
              Decisão CDI
            </span>
            <span
              className="cursor-pointer px-2.5 py-1 text-[8.5px] font-mono font-semibold rounded-full bg-emerald-500/10 border border-emerald-500/25 text-emerald-400 hover:bg-emerald-500/20 transition"
          ...
          <div className="ai-chat-input-bar border-t border-white/5 bg-black/40 flex items-center p-1.5">
            ...
            <button 
              ...
              className="h-7 w-7 rounded-xl bg-[#d4b87a] text-black font-bold flex items-center justify-center cursor-pointer hover:scale-105 active:scale-98 transition"
            >
              ›
            </button>
          </div>
          ...
          <div className="flex items-center justify-between border-b border-white/5 pb-2">
            <div className="flex items-center gap-1">
              <button 
                ...
                className={`px-2 py-1 rounded-lg text-[8px] font-mono font-bold transition flex items-center gap-1 ${rightPanelTab === 'garden' ? 'bg-[#d4b87a] text-black' : 'text-white/40'}`}
              >
              ...
              <button 
                ...
                className={`px-2 py-1 rounded-lg text-[8px] font-mono font-bold transition flex items-center gap-1 ${rightPanelTab === 'multimodal' ? 'bg-[#d4b87a] text-black' : 'text-white/40'}`}
              >
              ...
              <button 
                ...
                className={`px-2 py-1 rounded-lg text-[8px] font-mono font-bold transition flex items-center gap-1 ${rightPanelTab === 'translate' ? 'bg-[#d4b87a] text-black' : 'text-white/40'}`}
              >
              ...
              <button 
                ...
                className={`px-2 py-1 rounded-lg text-[8px] font-mono font-bold transition flex items-center gap-1 ${rightPanelTab === 'embeddings' ? 'bg-[#d4b87a] text-black' : 'text-white/40'}`}
              >
                <Compass className="h-3 w-3" />
                <span>Embed Sandbox</span>
              </button>
            </div>
            <span className="text-[7px] font-mono bg-blue-500/15 text-blue-400 border border-blue-500/25 px-1 py-0.5 rounded">
              FREE
            </span>
          </div>
            ...
            <div className="flex-1 flex flex-col justify-between mt-2 overflow-y-auto scrollbar-none animate-fadeIn">
              <div className="flex flex-col gap-2">
                ...
                {model.startsWith('gemini') && (
                  <div className="flex items-center justify-between p-1.5 bg-white/[0.02] border border-white/5 rounded-lg text-[8px] font-mono">
                    ...
                    <button
                      ...
                      className={`px-2 py-0.5 rounded text-[7.5px] font-mono border transition ${expressMode ? 'bg-[#d4b87a]/20 text-[#d4b87a] border-[#d4b87a]/40' : 'bg-black/40 text-white/40 border-white/10'}`}
                    >
                ...
                <div className="bg-black/50 border border-white/5 rounded-lg p-2.5 font-mono text-[7px] leading-relaxed relative group overflow-hidden max-h-[140px] overflow-y-auto scrollbar-none">
                  ...
                  <pre className="text-emerald-400/90 whitespace-pre-wrap">{renderDynamicCode()}</pre>
                </div>
                ...
                {(model.startsWith('gemma') || model.startsWith('deepseek') || model.startsWith('llama') || model === 'mimo-v2.5' || model === 'voyage-multimodal-3.5' || model === 'voyage-4-lite') && (
                  <div className="mt-1 space-y-1">
                    <div className="flex justify-between text-[8px] font-mono">
                      <span className="text-[#d4b87a] font-bold">Status do Cluster TPU:</span>
                      <span>{tuningProgress}%</span>
                    </div>
                    <div className="w-full h-1 bg-black/60 rounded-full overflow-hidden border border-white/5">
                      <div 
                        className="h-full bg-gradient-to-r from-[#d4b87a] to-blue-400 transition-all duration-700" 
              ...
              {(model.startsWith('gemma') || model.startsWith('deepseek') || model.startsWith('llama') || model === 'mimo-v2.5' || model === 'voyage-multimodal-3.5' || model === 'voyage-4-lite') ? (
                ...
                <div className="border border-white/5 bg-black/40 rounded-lg p-2.5 mt-2 flex-1 flex flex-col justify-center items-center gap-1 text-center font-mono">
                  <Binary className="h-6 w-6 text-[#d4b87a]/40" />
                  <span className="text-[8px] text-[#d4b87a]">Conexão Instantânea de API Ativa</span>
              ...
              {(model.startsWith('gemma') || model.startsWith('deepseek') || model.startsWith('llama') || model === 'mimo-v2.5' || model === 'voyage-multimodal-3.5' || model === 'voyage-4-lite') && (
                <div className="mt-2">
                  {tuningProgress === 100 ? (
                    <div className="w-full py-1.5 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 rounded-xl text-[8px] font-mono font-bold flex items-center justify-center gap-1.5">
                    ...
                    <button 
                      ...
                      className="w-full py-1.5 bg-[#d4b87a] hover:bg-[#e6c98c] disabled:opacity-50 text-black font-bold rounded-xl text-[8px] font-mono flex items-center justify-center gap-1.5 cursor-pointer active:scale-98 transition-all"
                    >
            ...
            <div className="flex-1 flex flex-col justify-between mt-2 overflow-y-auto scrollbar-none animate-fadeIn">
              ...
              <div className="grid grid-cols-2 gap-1 bg-black/40 p-1 rounded-lg border border-white/5 mb-2">
                <button
                  ...
                  className={`py-1 rounded text-[8px] font-mono font-bold transition flex items-center justify-center gap-1 cursor-pointer ${multimodalType === 'image' ? 'bg-[#d4b87a]/15 text-[#d4b87a] border border-[#d4b87a]/20' : 'text-white/40'}`}
                >
                ...
                <button
                  ...
                  className={`py-1 rounded text-[8px] font-mono font-bold transition flex items-center justify-center gap-1 cursor-pointer ${multimodalType === 'video' ? 'bg-amber-500/15 text-amber-400 border border-amber-500/20' : 'text-white/40'}`}
                >
                ...
                <div className="space-y-2 flex-1 flex flex-col justify-between">
                  <div className="space-y-2">
                    <div className="grid grid-cols-2 gap-1.5">
                      <div className="flex flex-col gap-0.5">
                        ...
                        <select 
                          ...
                          className="bg-black border border-white/10 rounded p-1 text-[7.5px] font-mono text-[#d4b87a] outline-none"
                        >
                    ...
                    <div className="flex items-center justify-between py-1 border-y border-white/5 text-[7.5px] font-mono text-white/50">
                      ...
                      <button 
                        ...
                        className={`px-1.5 py-0.5 rounded text-[7px] font-mono border transition ${enhancePrompt ? 'bg-amber-500/10 text-amber-400 border-amber-500/35' : 'text-white/20 border-white/10'}`}
                      >
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <textarea 
                        ...
                        className="bg-black border border-white/10 rounded p-1 text-[8px] text-white/90 h-[40px] resize-none outline-none focus:border-[#d4b87a] scrollbar-none"
                      />
                    </div>
                  </div>
                  ...
                  {isGeneratingImage && (
                    <div className="border border-white/5 bg-[#050505] rounded-lg mt-1 overflow-hidden flex flex-col justify-between min-h-[50px]">
                      <div className="p-1.5 font-mono text-[5.5px] text-amber-400/90 h-[50px] overflow-y-auto space-y-0.5 leading-normal scrollbar-none">
                  ...
                  {generatedImages.length > 0 && !isGeneratingImage && (
                    <div className="mt-1 relative rounded-lg border border-[#d4b87a]/20 bg-black/40 overflow-hidden flex items-center justify-center p-1 group">
                      <img 
                        src={generatedImages[0]} 
                        alt="Generated Mockup" 
                        className="max-h-[60px] object-contain rounded-md filter drop-shadow-[0_0_8px_rgba(212,184,122,0.2)]" 
                      />
                      <div className="absolute bottom-1 right-1 bg-black/80 px-1 py-0.5 rounded text-[5px] font-mono text-emerald-400 border border-emerald-500/30">
                        SYNTHID PROTECTED
                      </div>
                    </div>
                  )}
                  ...
                  <button 
                    ...
                    className="w-full mt-2 py-2 bg-[#d4b87a] text-black font-bold rounded-xl text-[9px] font-mono flex items-center justify-center gap-1.5 cursor-pointer active:scale-98 transition"
                  >
              ...
              {multimodalType === 'video' && (
                <div className="space-y-2 flex-1 flex flex-col justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-1.5">
                      <div className="flex flex-col gap-0.5">
                        ...
                        <select 
                          ...
                          className="bg-black border border-white/10 rounded p-1 text-[7.5px] font-mono text-amber-400 outline-none"
                        >
                      ...
                      <div className="flex flex-col gap-0.5">
                        ...
                        <button
                          ...
                          className={`w-full p-1 rounded text-[8px] font-mono border transition flex items-center justify-center gap-1 cursor-pointer ${veoAudio ? 'bg-amber-500/10 text-amber-400 border-amber-500/35' : 'text-white/20 border-white/10'}`}
                        >
                  ...
                  {isGeneratingVideo && (
                    <div className="border border-white/5 bg-[#050505] rounded-lg mt-1 overflow-hidden flex flex-col justify-between min-h-[60px]">
                      <div className="bg-black/95 px-2 py-0.5 flex items-center justify-between border-b border-white/5">
                        <div className="text-[#d4b87a] font-mono text-[5.5px] font-bold">
                  ...
                  {generatedVideos.length > 0 && !isGeneratingVideo && (
                    <div className="mt-1 relative rounded-lg border border-amber-500/20 bg-black/40 overflow-hidden flex flex-col items-center justify-center p-1.5">
                      <div className="flex items-center gap-1 text-emerald-400 font-mono text-[7px] font-bold mb-1">
                      ...
                      />
                      <div className="absolute bottom-2 right-2 bg-black/90 px-1 py-0.5 rounded text-[5px] font-mono text-amber-400 border border-amber-500/30">
                        VEO SynthID SECURE
                      </div>
                    </div>
                  )}
                  ...
                  <button 
                    ...
                    className="w-full mt-2 py-2 bg-amber-500 text-black font-bold rounded-xl text-[9px] font-mono flex items-center justify-center gap-1.5 cursor-pointer active:scale-98 transition"
                  >
            ...
            <div className="flex-1 flex flex-col justify-between mt-2 overflow-y-auto scrollbar-none animate-fadeIn">
              <div className="space-y-2 flex-1 flex flex-col justify-between">
                <div className="space-y-2">
                  ...
                  <div className="flex flex-col gap-0.5">
                    ...
                    <textarea 
                      ...
                      className="bg-black border border-white/10 rounded p-1 text-[7.5px] font-mono text-[#d4b87a] h-[45px] resize-none outline-none focus:border-[#d4b87a] scrollbar-none"
                    />
                  </div>
                ...
                {translationOutput && !isTranslating && (
                  <div className="mt-1 relative rounded-lg border border-[#d4b87a]/20 bg-black/40 p-2 font-mono text-[8px] text-white/90 max-h-[60px] overflow-y-auto scrollbar-none">
                    <div className="text-[6px] text-white/30 uppercase tracking-widest border-b border-white/5 pb-0.5 mb-1 flex items-center justify-between">
                      ...
                      <span className="text-emerald-400 font-bold">Glossário OK</span>
                    </div>
                ...
                <button 
                  ...
                  className="w-full mt-2 py-1.5 bg-[#d4b87a] text-black font-bold rounded-xl text-[8px] font-mono flex items-center justify-center gap-1.5 cursor-pointer active:scale-98 transition"
                >
              ...
              {model === 'voyage-4-lite' ? (
                ...
                <div className="space-y-2 flex-1 flex flex-col justify-between text-[8px] font-mono">
                  <div className="space-y-2">
                      ...
                      <div className="flex flex-col gap-0.5">
                        ...
                        <div className="grid grid-cols-2 gap-1">
                          ...
                          <select 
                            ...
                            className="bg-black border border-white/10 rounded p-0.5 text-[7px] font-mono text-[#d4b87a] outline-none"
                          >
                    ...
                    <div className="flex flex-col gap-0.5">
                      ...
                      <textarea 
                        ...
                        className="bg-black border border-white/10 rounded p-1 text-[7.5px] text-white/90 h-[50px] resize-none outline-none focus:border-[#d4b87a] scrollbar-none"
                      />
                    </div>
                  </div>
                  ...
                  {voyage4Result && !isVoyage4Embedding && (
                    <div className="mt-1 relative rounded-lg border border-emerald-500/20 bg-black/40 p-2 font-mono text-[6.5px] text-white/90 max-h-[85px] overflow-y-auto scrollbar-none">
                      <div className="text-[6px] text-white/30 uppercase tracking-widest border-b border-white/5 pb-0.5 mb-1 flex items-center justify-between">
                        <span>LOTE DE EMBEDDINGS ({voyage4Result.totalTexts} Vetores × {voyage4Result.dimensions}d)</span>
                        <span className="text-[#d4b87a] font-bold">{voyage4Result.dataType}</span>
                      </div>
                ...
                <div className="space-y-2 flex-1 flex flex-col justify-between text-[8px] font-mono">
                      ...
                      <div className="flex items-center gap-3">
                        <label className="flex items-center gap-1 cursor-pointer">
                          <input 
                            ...
                            className="rounded accent-[#d4b87a] cursor-pointer"
                          />
                          <span>+ Imagem</span>
                        </label>
                        <label className="flex items-center gap-1 cursor-pointer">
                  ...
                  {voyageResult && !isVoyageEmbedding && (
                    <div className="mt-1 relative rounded-lg border border-emerald-500/20 bg-black/40 p-2 font-mono text-[7px] text-white/90">
                      <div className="text-[6px] text-white/30 uppercase tracking-widest border-b border-white/5 pb-0.5 mb-1 flex items-center justify-between">
                        ...
                        {voyageResult.vector.map((val: any, idx: number) => {
                          ...
                          return (
                            <div 
                              ...
                              style={{ 
                                height: `${height}%`, 
                                background: val > 0 ? 'rgba(74, 222, 128, 0.6)' : 'rgba(212, 184, 122, 0.6)',
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between py-1.5 border-y border-white/5 text-[7px] font-mono text-white/50">
                      ...
                      <button
                        ...
                        className={`px-2 py-0.5 rounded text-[6.5px] border transition ${jinaLateChunking ? 'bg-amber-500/10 text-amber-400 border-amber-500/35' : 'text-white/20 border-white/10'}`}
                      >
                  ...
                  {embeddingResult && !isEmbedding && (
                    <div className="mt-1 relative rounded-lg border border-emerald-500/20 bg-black/40 p-2 font-mono text-[7px] text-white/90">
                      <div className="text-[6px] text-white/30 uppercase tracking-widest border-b border-white/5 pb-0.5 mb-1 flex items-center justify-between">
                        ...
                        <span className="text-[#d4b87a] font-bold">L2 NORMALIZED</span>
                      </div>
                      <div className="text-[#4ade80] font-bold truncate mb-1">
      ...
      <div className="hero-footer relative z-20">
        ...
        <div className="action-group">
          <button className="btn-enter-scene text-[#1a120a] flex items-center gap-1.5 bg-[#d4b87a] hover:bg-[#e6c98c]">
