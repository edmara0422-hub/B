  ...
  return (
    <button
      ...
      className={`relative inline-flex items-center justify-center p-2 rounded-full transition-all duration-300 shadow-[inset_0_1px_1px_rgba(255,255,255,0.05),0_2px_4px_rgba(0,0,0,0.4)] ${
        isPlaying
          ? 'bg-gradient-to-r from-emerald-500/20 to-teal-500/20 text-emerald-400 border border-emerald-500/30 ring-1 ring-emerald-500/50 shadow-[0_0_15px_rgba(16,185,129,0.2)]'
          : error
    ...
    >
      {isLoading ? (
        <Loader2 className="w-4 h-4 animate-spin text-[#d4b87a] [.theme-silver_&]:text-[#cbd5e1]" />
      ) : isPlaying ? (
