    ...
    <div className="w-full flex flex-col gap-6" style={{ fontFamily: "'Poppins', -apple-system, system-ui, sans-serif" }}>
      ...
      <div className="w-full cockpit-grid items-stretch min-h-[750px]">
        ...
        <div className="flex-1 flex flex-col gap-5 justify-start">
          ...
          <div className="p-5 rounded-3xl backdrop-blur-xl border" style={{ background: 'rgba(8, 8, 10, 0.85)', borderColor: 'rgba(197, 151, 64, 0.25)' }}>
            <div className="flex items-center gap-2 mb-3 pb-2" style={{ borderBottom: '1px solid rgba(197, 151, 64, 0.15)' }}>
              <ShieldAlert className="h-4 w-4 text-[#c9943a]" />
              <span className="text-[10px] font-bold uppercase tracking-[0.15em] text-[#c9943a]">
              ...
              {matrizRules.map((rule, idx) => {
                ...
                return (
                  <div 
                    ...
                    style={{
                      borderColor: 'rgba(197, 151, 64, 0.12)',
                      background: 'rgba(255, 255, 255, 0.01)',
                    }}
                  >
                    {/* Círculo do Ícone */}
                    <div className="h-7 w-7 rounded-full border flex items-center justify-center shrink-0" style={{ borderColor: 'rgba(197, 151, 64, 0.35)', background: 'rgba(197, 151, 64, 0.05)' }}>
                      <IconComp className="h-3.5 w-3.5 text-[#c9943a]" />
                    </div>
                    {/* Textos */}
                    <div className="flex flex-col leading-tight">
                      <span className="text-[#c9943a] text-[9.5px] font-bold tracking-wider font-mono uppercase">
                        {rule.title}
                      </span>
