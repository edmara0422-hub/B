...
export function SioPanel({ initialTab }: { initialTab?: SioSubTab }) {
  ...
  const getMaturityLevel = (score: number) => {
    ...
    return { text: 'Mapeado', color: '#d4b87a' }
  }
    ...
    <div className="w-full space-y-4">
      ...
      <style>{`
        ...
        .cortex-orb .orb {
          ...
          height: 80px;
          border-radius: 50%;
          background: radial-gradient(circle, rgba(212, 184, 122, 0.25) 0%, transparent 70%);
          border: 0.2px solid rgba(212, 184, 122, 0.4);
          display: flex;
          align-items: center;
          justify-content: center;
          position: relative;
          ...
          >
            <div className="dash-card-systems">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <div className="text-[7.5px] font-mono text-[#d4b87a] tracking-[0.2em] font-bold uppercase mb-1">SEC · 01 ◆ Finanças</div>
                  <h3 className="text-[15px] lg:text-xl font-light text-white tracking-wide">
                    Cockpit <span className="text-[#d4b87a] font-medium">Financeiro</span>
                  </h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 bg-[#d4b87a]/[0.02] border border-[#d4b87a]/10 rounded-xl p-5 mb-6">
                <div>
                  <span className="block text-[11px] font-bold text-[#d4b87a] mb-1">Parar de Chutar</span>
                  <p className="text-[10px] text-white/60 leading-relaxed">Diz se o seu preço (ticket) realmente paga o seu custo real (burn).</p>
                </div>
                <div>
                  <span className="block text-[11px] font-bold text-[#d4b87a] mb-1">Alerta de Colisão</span>
                  <p className="text-[10px] text-white/60 leading-relaxed">O Runway mostra quantos meses de fôlego você tem hoje.</p>
                </div>
                <div>
                  <span className="block text-[11px] font-bold text-[#d4b87a] mb-1">Filtro de Ruído</span>
                  <p className="text-[10px] text-white/60 leading-relaxed">Foco no gargalo real, não no que aparece mais.</p>
                </div>
                <div>
                  <span className="block text-[11px] font-bold text-[#d4b87a] mb-1">Prova de Valor</span>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center border-b border-white/10 pb-2">
                  <span className="text-[11.5px] font-mono text-white/80 flex items-center gap-1.5">
                    <Settings className="h-3.5 w-3.5 text-[#d4b87a]" />
                  ...
                  <div className="space-y-4 flex flex-col justify-between">
                    ...
                    <div className="bg-black/30 border border-white/[0.05] p-5 rounded-xl space-y-2 mt-4">
                      ...
                      <div className="flex justify-between items-center text-xs">
                        ...
                        <b className="text-[#d4b87a] font-mono">R$ {parseFloat(cac).toLocaleString('pt-BR')}</b>
                      </div>
                      <div className="flex justify-between items-center text-xs">
        ...
        {subTab === 'pricing' && (
          ...
          >
            <div className="dash-card-systems">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <div className="text-[7.5px] font-mono text-[#d4b87a] tracking-[0.2em] font-bold uppercase mb-1">SEC · 02 ◆ Smart Pricing</div>
                  <h3 className="text-[15px] lg:text-xl font-light text-white tracking-wide">
                    Regras <span className="text-[#d4b87a] font-medium">Ativas</span>
                  </h3>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="p-5 bg-white/[0.01] border border-white/[0.05] rounded-xl space-y-4">
                  <div className="text-xs font-mono font-bold text-[#d4b87a] tracking-wider uppercase border-b border-white/[0.06] pb-2">
                    Otimização Recomendada
                  </div>
                  <div className="space-y-3">
                    <div className="flex gap-2 items-start text-xs">
                      <span className="text-[#d4b87a] font-bold font-mono">α</span>
                      <p className="text-white/80">
                        R1 (Trial 14d) com <b>88% de retenção</b>. Migrar trial padrão de 7d→14d para todos segmentos.
                      </p>
                    </div>
                    <div className="flex gap-2 items-start text-xs">
                      <span className="text-[#d4b87a] font-bold font-mono">β</span>
                      <p className="text-white/80">
        ...
        {subTab === 'ia' && (
          ...
          >
            <div className="dash-card-systems">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <div className="text-[7.5px] font-mono text-[#d4b87a] tracking-[0.2em] font-bold uppercase mb-1">SEC · 03 ◆ IPBA AI</div>
                  <h3 className="text-[15px] lg:text-xl font-light text-white tracking-wide">
                    Insight <span className="text-[#d4b87a] font-medium">Operacional</span>
                  </h3>
                </div>
              </div>
              ...
              <div className="cortex">
                ...
                <div className="cortex-msg">
                  <div className="ttl">
                    <span className="text-[#d4b87a] font-mono">INSIGHT · #4473</span>
                  ...
                  <div className="actions mt-2 flex flex-wrap gap-2">
                    <button
                      ...
                      className="px-3.5 py-1.5 rounded bg-[#d4b87a] hover:bg-[#c5a55a] text-black font-semibold text-xs tracking-wider transition disabled:opacity-40 disabled:pointer-events-none"
                    >
                      Aplicar Regra
                    </button>
        ...
        {subTab === 'processos' && (
          ...
          >
            <div className="dash-card-systems">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <div className="text-[7.5px] font-mono text-[#d4b87a] tracking-[0.2em] font-bold uppercase mb-1">SEC · 04 ◆ Processos</div>
                  <h3 className="text-[15px] lg:text-xl font-light text-white tracking-wide">
                    Mapeamento & <span className="text-[#d4b87a] font-medium">Automação de Processos</span>
                  </h3>
                  <p className="text-[10px] lg:text-[11.5px] text-white/50 mt-1 max-w-lg">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1.4fr_1fr] gap-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-black/15 p-5 rounded-xl border border-white/[0.04] space-y-4">
                    <h4 className="text-[10.5px] font-mono font-bold text-[#d4b87a] tracking-wider uppercase border-b border-white/[0.06] pb-2">
                      ...
                      {(['p1', 'p2', 'p3'] as const).map(key => (
                        <label key={key} className="flex items-start gap-3 text-xs text-white/80 cursor-pointer select-none">
                          <input
                            ...
                            className="h-4 w-4 rounded border-white/20 bg-black/40 text-[#d4b87a] focus:ring-0 focus:ring-offset-0 accent-[#d4b87a] mt-0.5"
                          />
                          <div>
                ...
                <div className="space-y-6">
                  {/* Gauge Card */}
                  <div className="bg-[#d4b87a]/[0.02] border border-[#d4b87a]/15 rounded-xl p-6 flex flex-col items-center justify-center text-center relative overflow-hidden bg-[radial-gradient(circle_at_top_right,rgba(212,184,122,0.05),transparent_60%)]">
