        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mt-6 relative z-10">
          ...
          <div className="lg:col-span-5 flex flex-col gap-5">
            <div className="bg-black/25 border border-white/[0.06] rounded-xl p-5 flex flex-col gap-3">
              ...
              <div className="flex justify-between items-end">
                <span className="text-xl font-semibold text-[#d2af5a]">NPS 42</span>
            ...
            <div className="bg-black/25 border border-white/[0.06] rounded-xl p-5 flex flex-col gap-4">
              <span className="font-mono text-[9px] text-[#d2af5a] tracking-wider uppercase border-b border-white/[0.08] pb-2">
                PULSE SEMANAL (CLIMA)
              </span>
              ...
              <div>
                <div className="flex justify-between text-[11px] text-white/85">
                  ...
                  <b className="text-[#d2af5a]">{energy}%</b>
                </div>
                <input
                  type="range"
              ...
              <div>
                <div className="flex justify-between text-[11px] text-white/85">
                  ...
                  <b className="text-[#d2af5a]">{focus}%</b>
                </div>
                <input
                  type="range"
                  className="pulse-slider"
          ...
          <div className="lg:col-span-7 flex flex-col gap-5">
            ...
            <div className="bg-black/25 border border-white/[0.06] rounded-xl p-5 flex flex-col gap-4">
              ...
              {sbiResult && (
                <div className="p-3 bg-[#d2af5a]/5 border border-[#d2af5a]/15 rounded-md text-[11px] leading-relaxed text-[#d2af5a]/90 font-medium italic">
                  {sbiResult}
                </div>
              )}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2.5 max-h-[175px] overflow-y-auto pr-1">
                {feedbacks.map(feed => (
                  ...
                  >
                    <div className="flex justify-between items-center text-[9px] text-[#d2af5a] font-mono">
                      <span>
