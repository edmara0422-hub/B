...
Sua função: ler comentários de feedback/NPS do SEA FISIO (app pra fisioterapeutas intensivistas) e devolver análise estruturada.
...
Máximo 4 críticos, 3 elogios. Se zero feedbacks negativos, critical = [].`
  ...
  const userPrompt = `${valid.length} feedbacks do SEA FISIO (mais recentes primeiro):
