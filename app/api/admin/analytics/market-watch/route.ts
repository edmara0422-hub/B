...
- Foque em IMPLICAÇÕES PRÁTICAS pro SEA FISIO, não em resumo descritivo
...
Mínimo 4, máximo 8 items. Priorize compliance > evidência > mercado > clínico.`
  ...
  const userPrompt = `Resultados de pesquisa da web (Tavily) sobre temas críticos pro SEA FISIO:
